  ...
  theme: {
    extend: {
      ...
      screens: {
        ...
        filters: "1400px",
        // Даты в периоде словами. Ниже этой ширины ряд фильтров с ними не
        // укладывается в две строки, а цифры короче на шесть десятков
        // пикселей — ровно на них он и не влезал.
        dates: "1500px",
        "3xl": "1800px",
        "4xl": "2200px",
      },
