        ...
        right={
          <InfoPopover>
            <p>
              ...
              историю, до самой первой операции. Месяц, в котором операций не
              было, из ленты не выпадает — он показывается с нулями, иначе
              список обрывался бы на провале в данных.
            </p>
            <p>
    ...
    <div className="space-y-4">
      ...
      {entry.txCount === 0 && (
        <div className="card card-pad text-sm text-muted">
          В этом месяце не было ни одной операции. Такие месяцы остаются в
          ленте: пропусти мы их, список обрывался бы на предыдущем месяце и
          выглядел бы так, будто данные пропали.
        </div>
      )}
