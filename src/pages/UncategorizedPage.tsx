    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted text-sm mt-1">
          Операции с пустой или общей категорией («Прочие», «Без категории») — собраны в одном месте. Подсказки ниже помогут быстро их разнести, а правила — категоризировать похожие автоматически.
        </p>
      </div>
