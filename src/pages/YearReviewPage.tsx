        ...
        info={
          <InfoPopover>
            ...
            <p>
              ...
              «DOSTAVKA YOLOCHKA» и «DOSTAVKA IZ YOLOCHKI» — это одна
              «Ёлочка». Строка банка остаётся только там, где контрагент к
        ...
        <TopList
          ...
          info={
            <p>
              ...
              «DOSTAVKA YOLOCHKA» и «DOSTAVKA IZ YOLOCHKI» — это одна
              «Ёлочка», и стоит она одной строкой с общей суммой. Строка банка
