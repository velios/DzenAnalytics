  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p className="mt-2 text-muted text-xs">
          Если включена двусторонняя синхронизация и удаление уже ушло в
          Дзен-мани, восстановление вернёт операцию только локально — в облаке
          она уже удалена. См. раздел «Удаление операций».
        </p>
      </>
    ),
  },
      ...
      <>
        ...
        <ul className="list-disc list-inside space-y-1 mt-2">
          ...
          <li>
            ...
            кнопкой «Восстановить». При выключенной синхронизации восстановление
            полностью возвращает операцию; при включённой и уже отправленном в
            облако удалении — только локально.
          </li>
        </ul>
      </>
    ),
