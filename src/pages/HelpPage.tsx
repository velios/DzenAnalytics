...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    body: (
      <>
        <p>
          <strong>v0.5 — новая страница.</strong> Сквозная лента всех операций под
  ...
  // ============================================================
  {
    ...
    group: "concepts",
    icon: CloudIcon,
    title: "Источник данных: CSV или Zenmoney API (v0.5)",
    body: (
      <>
        <p>
  ...
  },
  {
    ...
    group: "concepts",
    icon: Pencil,
    title: "Локальные правки операций (v0.5)",
    body: (
      <>
        <p>
  ...
  },
  {
    ...
    group: "concepts",
    icon: Settings2,
    title: "Авто-калибровка от API (v0.5)",
    body: (
      <>
        <p>
  ...
  },
  {
    ...
    group: "concepts",
    icon: Tag,
    title: "Иконки и цвета категорий из API (v0.5)",
    body: (
      <>
        <p>
  ...
  },
  {
    ...
    group: "concepts",
    icon: Save,
    title: "Авто-бэкап по расписанию (v0.5)",
    body: (
      <>
        <p>
  ...
  },
  {
    ...
    body: (
      <>
        ...
        <p className="mt-2">
          В v0.5 появился <strong>авто-бэкап по расписанию</strong> (день/неделя/месяц)
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted text-sm mt-1">
          ...
          API, калибровка, FIRE, σ, правила и т.п.). Разделы с пометкой <strong>v0.5</strong>
          — самые свежие возможности. Кликайте по разделам, чтобы раскрыть.
        </p>
      </div>
