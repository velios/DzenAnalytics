    ...
    body: (
      <>
        ...
        <p className="mt-2 text-muted text-xs">
          ...
          Дзен-мани. Смена типа операции (Расход/Доход/Перевод/Возврат) и счёта
          меняется локально, но пока <strong>не передаётся</strong> в облако —
          для этого используйте мобильное приложение.
        </p>
      </>
    ),
  },
    ...
    body: (
      <>
        ...
        <p className="mt-2 text-muted text-xs">
          ...
          сумма, валюта, категория и подкатегория. Смена типа операции и счёта пока
          не передаётся. Перед каждой отправкой автоматически делается облачный
          снимок-страховка (см. «Облачные снимки»). Конфликты сервер разрешает по
          правилу «последний выиграл» по полю <code>changed</code>.
        </p>
      </>
    ),
  },
