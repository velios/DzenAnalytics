// Как настроена страница «Счета»: вкладка, вид графика, фильтры и порядок
// списка.
//
...
// (`useDisplayStore`), а не в общем фильтре (`useFiltersStore`) — тот про то,
 ...
 * `MultiSelect` и у общего фильтра.
 */
