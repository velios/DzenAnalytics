      ...
      <SettingsSectionHeader
        ...
        right={
          <InfoPopover label="Откуда берутся участники">
            ...
            <p>
              <InfoTerm>Почему себя надо отметить</InfoTerm> — по данным Дзен-мани
              не определить, чей это токен, а угадывать нельзя: ошибка открыла бы
              чужие счета и спрятала ваши.
            </p>
          </InfoPopover>
        }
      />
      {/* Предупреждение — вместо подписи, теми же строками, а не плашкой под
          ней: плашка появлялась и пропадала и меняла высоту карточки. Почему
          отметку не угадать — в «?» у заголовка. */}
      {ownerId == null ? (
