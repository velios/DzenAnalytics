        ...
        help={
          <>
            <p>
              ...
              Дзен-мани: правила, цели, сохранённые фильтры, разрезы данных,
              настройки бюджета (периметр счетов, переводы, вид и прогноз),
              настройки расчётов (теги, счета вне баланса, свободные деньги,
              свой первый день месяца, счета вне FIRE), оформление (тема,
              копейки, размер текста, строка из выписки, панель фильтров, вид
              месяца), имена участников, раскладка главной и основное меню.
            </p>
            <p>
            ...
            <p>
              ...
              берутся из Дзен-мани, а списки — правила, цели, фильтры, разрезы —
              объединяются с теми, что уже есть. Дальше побеждает более поздняя
              правка: по каждой настройке и каждому элементу списка отдельно.
            </p>
          </>
        }
        control={
