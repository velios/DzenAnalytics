...
Теперь цвета читаются корректно — категории отображаются ровно теми цветами, что выбраны в Дзен-мани (на реальных данных вернулось 53 цвета из 68). Если у категории цвет вообще не задан, то, как и раньше, подбирается стабильный цвет по названию.
