...
- **«Регулярные платежи»**: новый столбец **«Статус»** — светофор (🟢 активные / 🔴 неактивные) вместо слова «протух»; переключатель **«Только активные»** стал тумблером у правого края, а счётчики на пилюлях периодов и карточка «Подорожали» теперь учитывают его — числа сходятся с «Найдено».
