...
> Токен **выпускает сам Дзен-мани** — zerro.app лишь посредник и не хранит его у себя. В DzenAnalytics токен живёт только в вашем браузере (IndexedDB) и никогда не попадает в git.
