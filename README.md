...
- **Двусторонняя синхронизация (push)** — отправка локальных правок и удалений
  ...
  комментарий, сумма, валюта, категория и подкатегория; смена типа операции и
  счёта пока не передаётся.
...
│   │   └── ImportPage.tsx             # /import        настройки: вкладки Данные / Валюты / Обработка / Бэкапы
│   │
