...
│   │   ├── EditTransactionModal.tsx   # редактирование операции (overlay-патч)
...
│   │   ├── useZenmoneyStore.ts        # токен/sync state Zenmoney API
...
│   │
│   ├── lib/zenmoneyApi.ts             # клиент /v8/diff/ + entity-cache
