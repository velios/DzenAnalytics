...
- **Командная палитра** (Ctrl+K / ⌘K / `/`) — fuzzy-поиск по всем 21 страницам,
...
- **Справка** (`/help`) — встроенный мини-документ: что такое калибровка, как
  считается FIRE, что значит σ в аномалиях, правила детекта регулярных платежей,
  все горячие клавиши и т.д.
